...
struct WidgetTimelineSource: TimelineProvider {
    ...
    func currentEntry() -> WidgetEntry {
        ...
        return WidgetEntry(date: date, envelope: Self.markExpiredProvidersStale(envelope, at: date))
    }
    ...
    private static func markExpiredProvidersStale(
        ...
        WidgetSnapshotEnvelope(
            ...
            providers: envelope.providers.map { provider in
            ...
            nextReset: envelope.nextReset,
            codexResetCredits: envelope.codexResetCredits
        )
    }
}
