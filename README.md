...
![Version 0.8.2](https://img.shields.io/badge/version-0.8.2-3b82f6)
![Tests 499](https://img.shields.io/badge/tests-499%20passed-2ea44f)
...
> 当前公开稳定版为[0.8.2](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.8.2)（macOS build `25`），提供双平台安装包和应用内更新；完整发布证据见[0.8.2发布记录](docs/development/2026-09-11-v0.8.2-release.md)。

> 当前公开稳定版为`0.8.2` / build `25`：Settings密度立即调整已展开悬浮条，左右贴边时保留圆角并加强反向肩弧。[Release Notes](docs/releases/v0.8.2.md)。
...
> `0.8.2` / build `25`稳定版：三档密度设置对已展开悬浮条立即生效，左右贴边轮廓保持圆角和清晰反向肩弧。[Release Notes](docs/releases/v0.8.2.md)。
...
稳定版页面：**[Download v0.8.2](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.8.2)**：
