...
Maintainers may remove, edit, or reject comments, commits, code, wiki edits, issues, and other contributions that do not align with this Code of Conduct, and will communicate moderation reasons when appropriate.
...
1. **Correction** — A private written warning for inappropriate language or unprofessional behavior.
2. **Warning** — A warning with consequences for continued behavior and a temporary restriction on interaction.
3. **Temporary Ban** — A temporary ban from interaction or public communication with the community.
4. **Permanent Ban** — Permanent removal for sustained violations, harassment, or aggression toward individuals.
