...
AI Token Meter 不把不同服务强行换算成同一个“额度”。未发布源码新增 Gemini，公开 0.5.1 仍为原三项服务。每个圆环严格遵循对应服务能够可靠获得的数据：
...
已验证的是合成账号的官方 CLI 隔离启动与本地代码回归，真实账号及原生 Windows 尚待验收。[完整范围与验证](../development/2026-09-08-gemini-collector.md)。
