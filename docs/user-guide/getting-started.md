...
从 [v0.6.0](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.6.0) 下载 `AI-Token-Meter-0.6.0-macOS-arm64.zip` 和同名 `.sha256`。在下载目录验证：
...
从 [v0.6.0](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.6.0) 下载 `AI-Token-Meter-0.6.0-windows-x64-setup.exe` 与同名 `.sha256`；不要从第三方网盘取得 Windows 版本。安装器是 current-user NSIS，不要求管理员权限；取得 Authenticode 证书前 Windows 可能显示 SmartScreen，请先确认发布页域名和 SHA-256。应用内更新 archive 另有 Tauri minisign 验证。
