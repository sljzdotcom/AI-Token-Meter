...
从 [v0.6.3](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.6.3) 下载 `AI-Token-Meter-0.6.3-macOS-arm64.zip` 和同名 `.sha256`，并在下载目录验证：
...
已有 macOS `0.2.x` 或更高版本、Windows 稳定版及旧 Preview 无需重新下载：Settings → About → **Check for Updates** → **Update Now**。三条更新入口均已指向 `0.6.3`；设置与凭据的存储位置保持不变。
