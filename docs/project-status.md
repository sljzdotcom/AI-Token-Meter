...
- Settings：Appearance、Floating Strip、Monitoring、Services、About 五个Tab；macOS提供默认English、简体中文和繁體中文，Windows提供English/简体中文，两端即时切换应用自有文案，Windows简中把Floating Strip显示为“悬浮条”且Settings始终使用系统字体；
