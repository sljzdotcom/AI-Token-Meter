...
**下一版品牌改进：** 双平台 About 作者社交图标链接及 Windows 设置顶部 Logo 已合入 main（`12ad5e2`），双平台 CI/构建通过，尚未发布；[完成证据](development/2026-09-07-about-branding.md)。CLI 安装器按点击在线获取，CLI 本体不内嵌安装包。
