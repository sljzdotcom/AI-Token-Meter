...
> **2026-09-02 展示变更：** 本规格最初设计的 Token 构成和模型排行卡片已由 `REQ-20260901-008` 取消。当前详情只显示官方额度、本机会话数、活跃日、Token 总量、每日趋势与隐私提示；底层聚合字段继续保留以兼容旧缓存。参见 [精简规格](2026-09-02-claude-detail-card-removal-design.md)。
