...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-001 | 双平台新版本发布 | 用户确认在四产品新用户接入一致性修复完成并验收后，直接生成并公开发布可供现有设备更新的新稳定版本 | 高 | 进行中 | 2026-09-09 | 0.6.1/build16精确候选`b4e7d30`独立审查0/0/0，PR #18首轮macOS/Windows原生CI全绿；下一步提交证据更新、等待最终PR CI、合入main并执行main双平台CI、签名资产和公开更新源验证。 | 用户原话“确认发布” · [PR #18](https://github.com/sljzdotcom/AI-Token-Meter/pull/18) · [macOS CI 34313976747](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34313976747) · [Windows CI 34313976820](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34313976820) · 本机490项Swift/124+5项Windows前端与协议/259项Rust/浏览器608角色/Release App/213份文档全绿 · 授权覆盖公开仓库推送、main合并、Tag、GitHub Release及应用内稳定更新源 |
...
| REQ-20260909-002 | 菜单面板品牌展示 | 用户要求截图中菜单弹出面板顶部AI Token Meter软件名旁增加应用Logo，融入现有背景，不突兀 | 中 | 待处理 | 2026-09-09 | 沿用既有应用Logo，建议小尺寸与标题/副标题整体垂直对齐、透明容器、不另加底板/粗框/强阴影，不挤压右侧刷新按钮或改变当前背景。按现有队列接续，开发先确认截图对应页面，两端等价面板保持品牌一致；重大视觉差异才交用户选择 | 用户截图菜单面板顶部缺应用Logo；截图路径仅随派工传递，不公开个人用量或截图元数据 |
