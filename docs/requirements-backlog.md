...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-008 | 双平台新版本发布 | 用户在确认macOS About作者行删除后明确要求发布新版本，供现有设备更新 | 高 | 进行中 | 2026-09-09 | 先完成REQ-006全部本机门禁并安全整合；随后按现有稳定发布流程生成下一补丁版本，要求macOS/Windows版本同步、双平台CI与签名资产通过、稳定更新源可验证。REQ-007涉及产品身份与额度语义，官方调研完成前不混入本次补丁版 | 用户原话“确认发布”；公开基线v0.6.2/build17 |
| REQ-20260909-006 | macOS About精简 | 用户明确要求删除macOS Settings→About中的“Author: Miller”整行 | 中 | 进行中 | 2026-09-09 | 实现与本机候选门禁完成，待提交并安全快进整合本地main。仅删除macOS可见作者行及其自然消失的间距；三条链接、版本/更新、README/LICENSE/版权和Windows保持。获授权的新版本发布由REQ-008独立追踪 | 定向15项、完整491项Swift、无Widget Release App、6份跨平台合同、222份文档、公开安全通过；审查0/0/0 |
