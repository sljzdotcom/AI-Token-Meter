...
| REQ-20260903-004 | 跨平台 | 制作功能对等的 Windows 版本；此后产品功能、版本号、文档、测试和 GitHub Release 原则上保持 macOS 与 Windows 同步 | 高 | 进行中 | 2026-09-03 | 代码、独立复审、双平台 main CI 与 NSIS 已完成；下一步需在交互式 Windows 11 x64 会话完成视觉/DPI/拖动/全屏/三服务/DeepSeek 官网验收，补产品截图，并配置 Tauri Secret 演练两版签名 Preview 更新 | [设计规格](design/specifications/2026-09-03-windows-platform-design.md)、[实施计划](design/implementation-plans/2026-09-03-windows-platform.md)、[开发日志](development/2026-09-03-windows-platform.md)、合并 `3920dae`、[macOS main CI 33743181782](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/33743181782)、[Windows main CI 33743181964](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/33743181964) |
...
| REQ-20260903-011 | 发布交付 | 将已合入 `main` 的稳定显示器位置修复及当前跨平台功能打包为下一版可安装 Preview；macOS 与 Windows 使用同一版本和 GitHub Release，提供校验、更新清单及标准发布文档 | 高 | 进行中 | 2026-09-03 | 首次 workflow 被 Windows 可执行位误判安全阻断；门禁已按 Git 模式修复，下一步提交修复并重跑双平台发布 | [发布流程](development/release-process.md)、[Release notes](releases/v0.3.0-preview.0.md)、[发布记录](development/2026-09-04-v0.3.0-preview.0-release.md) |
| REQ-20260904-001 | 发布门禁缺陷 | 修复跨平台合同检查器在 Windows runner 上把 Git 已跟踪为可执行的发布入口误判为不可执行，导致双平台 Preview 发布在代码测试通过后被阻断 | 高 | 进行中 | 2026-09-04 | 失败先行的真实 Git 仓库回归与最小修复已通过；等待 Windows Release workflow 复验 | [失败 workflow](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/33813010911)、`scripts/test-cross-platform-contracts.sh` |
