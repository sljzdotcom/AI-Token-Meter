...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-008 | 双平台新版本发布 | 用户在确认macOS About作者行删除后明确要求发布新版本，供现有设备更新 | 高 | 进行中 | 2026-09-09 | PR #20首轮精确候选`9c6c067`已通过原生双平台CI；下一步等待证据提交后的最终候选CI，再合入main、执行签名Release、三个更新源和匿名公网验收。REQ-007涉及产品身份与额度语义，官方调研完成前不混入本次补丁版 | 用户原话“确认发布” · 基线`1015ea3` · 计划`6506692` · 版本候选`bf915c7` · [PR #20](https://github.com/sljzdotcom/AI-Token-Meter/pull/20) · [macOS CI 34352300567](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34352300567) · [Windows CI 34352300602](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34352300602) · 491 Swift/124前端/261 Rust/Release App全绿 · [发布记录](development/2026-09-09-v0.6.3-release.md) |
