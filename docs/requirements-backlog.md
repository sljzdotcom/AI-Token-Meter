...
| REQ-20260908-015 | 新用户接入 / 四产品一致性 | Gemini 功能完成后全面检查四个按钮及 Settings 接入流程，面向任意新用户而非仅作者三台设备；已安装客户端自动识别，未安装或不可用时清晰提示并给出适当操作，四产品体验一致 | 高 | 进行中 | 2026-09-08 | 2026-09-09最终独立复核0/0/0：Windows DeepSeek验证锁定重复替换、状态检查和聚焦刷新，Rust后端串行化Key事务；普通状态读取不再误报Key验证，凭据恢复入口排在保留的官网历史之前。完整本机门禁已绿，进入PR原生双平台CI与整合，随后接续已授权发布。 | 发布收尾基线`e3c4071` · 接单`57a8293` · 设计`7886a63` · 实现`80da33f` · 审查修复`4149086`/`978a170` · macOS 488项/Release · Windows前端122项/Rust258项/浏览器608角色 · [审计与设计](design/specifications/2026-09-09-four-provider-onboarding-consistency-design.md) · [实施计划](design/implementation-plans/2026-09-09-four-provider-onboarding-consistency.md) · [开发记录](development/2026-09-09-four-provider-onboarding-consistency.md) |
