...
| REQ-20260904-008 | 双平台 Preview 发布 | 将当前 `main` 中已完成的 Windows DeepSeek、窗口生命周期与紧凑界面修复发布为新的 macOS/Windows 同版本 Preview；提供可下载 Release、SHA-256、签名更新清单，并验证其他机器可发现新版 | 高 | 进行中 | 2026-09-04 | 正在准备 `0.3.0-preview.3`（build `10`）版本提交与双平台门禁；发布后从公网重新下载并验证资产和更新源 | [Release notes](releases/v0.3.0-preview.3.md) · [发布记录](development/2026-09-04-v0.3.0-preview.3-release.md) · 待补版本提交、Tag、Release workflow、公网资产与更新源证据 |
