...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-006 | macOS About精简 | 用户明确要求删除macOS Settings→About中的“Author: Miller”整行 | 中 | 进行中 | 2026-09-09 | 仅删除macOS可见作者行及其无用留白，保留现有Twitter/GitHub/Telegram图标链接、版本/更新和其他品牌内容，不删除代码版权/许可证信息，不改Windows已完成的作者行移除。开发负责回归、文档和本地整合，未授权本次新发布 | 用户本次明确修改请求；基线公开v0.6.2 |
