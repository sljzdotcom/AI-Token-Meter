...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-001 | 双平台新版本发布 | 用户确认在四产品新用户接入一致性修复完成并验收后，直接生成并公开发布可供现有设备更新的新稳定版本 | 高 | 进行中 | 2026-09-09 | 0.6.1/build16候选`2f73061`及阶段修正`772a216`完成，独立审查最终0/0/0；下一步推送PR并执行候选与main双平台原生CI、签名资产和公开更新源验证。 | 用户原话“确认发布” · 本机490项Swift/124+5项Windows前端与协议/259项Rust/浏览器608角色/Release App/213份文档全绿 · 授权覆盖公开仓库推送、main合并、Tag、GitHub Release及应用内稳定更新源 |
