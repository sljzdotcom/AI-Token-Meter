...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260901-001 | 服务认证 | Settings 始终显示 Claude、Codex 当前账户和登录按钮；支持官方 CLI 重新登录；DeepSeek 显示遮罩 Key，并安全替换 API Key | 高 | 进行中 | 2026-09-01 | 编写实施计划后直接开发 | [设计规格](superpowers/specs/2026-09-01-service-account-relogin-design.md)、`8a396af` |
| REQ-20260901-002 | 项目治理 | 建立项目级“待完成需求”列表；以后每条新需求先登记，可分类、标记完成/待确认，并在当前任务结束后继续读取处理 | 高 | 进行中 | 2026-09-01 | 完成本文件、根级工作规则和文档入口并提交 | 本文件、`AGENTS.md` |
