...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-008 | 双平台新版本发布 | 用户在确认macOS About作者行删除后明确要求发布新版本，供现有设备更新 | 高 | 进行中 | 2026-09-09 | 0.6.3/build18候选本机全套与0/0/0发布审查已完成；下一步推送PR并等待原生双平台CI，再合入main、执行签名Release、三个更新源和匿名公网验收。REQ-007涉及产品身份与额度语义，官方调研完成前不混入本次补丁版 | 用户原话“确认发布” · 基线`1015ea3` · 计划`6506692` · 版本候选`bf915c7` · 491 Swift/124前端/261 Rust/Release App全绿 · [发布记录](development/2026-09-09-v0.6.3-release.md) |
