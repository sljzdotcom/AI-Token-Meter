...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260909-001 | 双平台新版本发布 | 用户确认在四产品新用户接入一致性修复完成并验收后，直接生成并公开发布可供现有设备更新的新稳定版本 | 高 | 进行中 | 2026-09-09 | 0.6.1/build16版本、发布资料与本机完整门禁通过；进入独立发布审查、候选提交、PR/main双平台原生CI、签名资产和公开更新源验证。 | 用户原话“确认发布” · 本机490项Swift/124+5项Windows前端与协议/259项Rust/浏览器608角色/Release App/213份文档全绿 · 授权覆盖公开仓库推送、main合并、Tag、GitHub Release及应用内稳定更新源 |
...
| 日期 | ID | 变化 | 说明 |
| --- | --- | --- | --- |
| 2026-09-09 | REQ-20260909-001 | 进行中 | 0.6.1/build16版本元数据、测试合同、Release Notes、发布计划、开发记录和用户指南已同步。本机463+3+18+6共490项Swift、124项前端+5项终端协议、production build、25项浏览器生命周期、8个Gemini详情场景、16组布局、608个文字角色、259项Rust、格式、严格Clippy、无Widget Release App、6份合同、213份Markdown及公开安全检查全绿；等待独立发布审查和候选提交。 |
