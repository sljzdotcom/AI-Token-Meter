...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260907-003 | Windows 详情字号 | Windows 三个产品的所有详情页文字在当前字号基础上统一再减少 1 号；macOS 不变 | 中 | 待处理 | 2026-09-07 | 并入 REQ-20260907-002 的 Windows 字体阶段；覆盖标题、数值、正文、按钮、图表标签、辅助说明与空/错误状态，统一减 1 CSS px，不用窗口缩放替代；Settings、托盘菜单和浮动条不随本项缩小 | 用户在多屏修复执行期间补充；验收：三个详情页在英文/中文及不同字体下均缩小且不裁切，macOS 字号无变化 |
