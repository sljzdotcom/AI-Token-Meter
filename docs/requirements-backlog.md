...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260907-010 | About CI 回归 | 原生 macOS CI 的失败提示渲染断言未通过；定位真实视图更新与测试读取时序，保留提示断言和有界失败 | 高 | 进行中 | 2026-09-07 | 本机通过，CI 419 项中仅 BrandLinksViewTests 提示视图断言失败；检查 SwiftUI 提交更新的时序，禁止跳过测试 | [失败 CI](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34088536876) · [本轮日志](development/2026-09-07-about-branding.md) |
...
| REQ-20260907-009 | 关于与品牌展示 | macOS/Windows 关于页在 Miller 作者后增加 Twitter @MillerPanYue 与项目 GitHub 链接、小图标；Windows Settings 顶部名称旁增加现有软件 Logo，与 macOS 呼应 | 中 | 进行中 | 2026-09-07 | 采用紧凑图标链接和本地软件 Logo，用户明确授权直接实施；基线 React 75、Swift 品牌 4 通过 | [规格](design/specifications/2026-09-07-about-branding-design.md) · [计划](design/implementation-plans/2026-09-07-about-branding.md) · [日志](development/2026-09-07-about-branding.md) · `a10481e` |
