...
| REQ-20260907-007 | Windows Settings 页签图标 | Windows 设置的外观、监测、服务、关于等页签名称增加图标便于区分，保留中英文文字和系统默认字体 | 中 | 待处理 | 2026-09-07 | 与 CLI 引导同轮交付，使用一致线性图标，不改变 macOS 页签 | 验收：四页签均图标+文字，中英文可辨识，键盘焦点与无障碍名称不重复 |
