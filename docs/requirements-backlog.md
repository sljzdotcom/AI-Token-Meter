...
| REQ-20260908-009 | About 界面与社交链接 | Windows 设置→关于移除“作者 Miller”整行和可见“作者链接”标题，仅保留 Twitter/GitHub 并新增带图标的 Telegram @sljzdotcom；macOS 也增加 Telegram 图标链接 | 中 | 进行中 | 2026-09-08 | 派给长期开发对话：Windows 中英文同步去除上述可见文字，三链接保持专业一致布局；Telegram 目标 https://t.me/sljzdotcom，macOS 原作者信息不变；补测试/文档，暂不发布 | 用户明确范围；完成后回传本需求对话核验 |
