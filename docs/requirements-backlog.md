...
| REQ-20260906-003 | CI可靠性 | 追踪偶发的macOS PTY父进程退出超时/并发输出缺失、CLI超时测试PID读取失败及Windows ConPTY采集超时；不删除断言或跳过测试 | 高 | 进行中 | 2026-09-06 | macOS计时/真实PTY Suite已拆成独立测试进程，本机458+3+13+6共480项通过。精确提交`dbb1fc6`的macOS CI全绿，Windows真实ConPTY成功/超时/取消/回收综合用例也首次全绿；后续137字节合成分片回归的两秒超时来自40KB累计帧重复解析与同测试程序并行负载。该回归已移入Cargo串行执行的独立集成测试程序，137/4096边界、两秒期限、命令顺序和60%断言全部保留；独立复审Critical/Important/Minor为0/0/0，本任务也重跑完整Rust 252项、格式、严格Clippy、6份合同、207份文档及公开安全门禁全绿，进入提交和原生CI。NSIS/PE尚未运行 | [开发记录](development/2026-09-06-compact-progressive-strip.md) · 原失败CI `34033000263`、`34033000265`、`34073917970` · [macOS失败34227393553](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34227393553) · [第四轮Windows失败34229619374](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34229619374) · [第五轮Windows反证34232052626](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34232052626) · [第六轮Windows字节证据34237111918](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34237111918) · [第八轮Windows分段证据34242730653](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34242730653) · [第九轮Windows完整帧34244232308](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34244232308) · [第十轮Windows分片超时34247798952](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/34247798952) · [Windows官方ECH语义](https://learn.microsoft.com/en-us/windows/console/console-virtual-terminal-sequences#text-modification) · [本轮发布记录](development/2026-09-08-v0.6.0-release.md) |
