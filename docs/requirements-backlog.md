...
| REQ-20260908-015 | 新用户接入 / 四产品一致性 | Gemini 功能完成后全面检查四个按钮及 Settings 接入流程，面向任意新用户而非仅作者三台设备；已安装客户端自动识别，未安装或不可用时清晰提示并给出适当操作，四产品体验一致 | 高 | 进行中 | 2026-09-08 | 2026-09-09完成失败先行实现：消除重复检查动作，修正DeepSeek首次保存/API Key与官网历史混淆，让Claude/Codex/DeepSeek详情直达Services，并保留带认证原因的旧额度。定向回归已绿；继续完整双平台门禁、独立审查、原生CI与整合，随后接续已授权发布。 | 发布收尾基线`e3c4071` · 接单`57a8293` · 设计`7886a63` · Windows前端119项 · macOS定向26项 · [审计与设计](design/specifications/2026-09-09-four-provider-onboarding-consistency-design.md) · [实施计划](design/implementation-plans/2026-09-09-four-provider-onboarding-consistency.md) · [开发记录](development/2026-09-09-four-provider-onboarding-consistency.md) |
