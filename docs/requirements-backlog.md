...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260908-011 | 浮动条外观 | 用户已明确要求 Windows/macOS 两端去掉悬浮条顶部小横线，不再需要该提示 | 中 | 待处理 | 2026-09-08 | 2026-09-08 用户批准：仅移除展开态横线装饰及无用样式，保留背景拖动、贴边、位置保存、Logo 布局和折叠态竖线；接续 REQ-010 开发交付后执行，补回归测试与文档，暂不发布 | 用户确认“小横线帮我去掉吧，两个版本都去掉”；macOS Capsule 关闭命中，Windows 横线 aria-hidden，拖动逻辑独立 |
