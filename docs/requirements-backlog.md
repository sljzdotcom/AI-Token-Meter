...
| --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-20260908-010 | macOS 设置缺陷 | 用户反馈设置中的“更新时间”为 5 分钟且无法修改；先核对实际控件含义，排查刷新间隔编辑/保存/生效链路并修复 | 高 | 进行中 | 2026-09-08 | 实现与439项测试/Release通过；失焦提前保存已在01da4da补真实焦点RED/GREEN并修复，22项聚焦测试通过，进入最终回归/复审；不改软件版本更新策略，暂不发布 | 已定位静态5分钟标签与300秒固定睡眠，无编辑/持久化链路 · [规格](design/specifications/2026-09-08-macos-refresh-interval-design.md) · [计划](design/implementation-plans/2026-09-08-macos-refresh-interval.md) |
