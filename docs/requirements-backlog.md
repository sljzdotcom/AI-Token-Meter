...
| REQ-20260903-001 | 发布缺陷 | 修复 GitHub macOS runner 高负载下 PTY 父进程退出等待超时及并发输出尾部丢失，恢复公开发布 CI | 高 | 进行中 | 2026-09-03 | CI `33744944628` 再现单个父进程退出等待超时；需验证低 QoS fallback wait 的调度反转并完成新的 main CI | [开发记录](development/2026-09-03-ci-pty-exit-race.md) · [复发 CI 33744944628](https://github.com/sljzdotcom/AI-Token-Meter/actions/runs/33744944628) |
