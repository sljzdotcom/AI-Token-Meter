...
| [v0.7.0 Release notes](releases/v0.7.0.md) | Google Antigravity迁移、65pt Compact浮动条与40pt菜单Logo |
...
| [v0.7.0 发布记录](development/2026-09-10-v0.7.0-release.md) | 版本/build19、功能整合、原生CI、签名资产与三个更新源证据 |
