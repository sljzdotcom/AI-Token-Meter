...
| [v0.9.0 Release notes](releases/v0.9.0.md) | macOS三语言即时切换、Services四产品Logo与自动隐藏展开轮廓修复 |
...
| [v0.9.0 发布记录](development/2026-09-12-v0.9.0-release.md) | 三语言、Services Logo、悬浮条修复与双平台稳定发布证据 |
