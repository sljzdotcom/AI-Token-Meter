...
当前65候选的定向结果：Windows前端17项、Rust原生偏好与位置9项、macOS真实渲染测试通过。78、70和65宽的2×三Provider截图均为572像素高，宽度分别为156、140和130像素，圆环尺寸保持。最终完整门禁在用户选定65或70后运行，避免把70候选的完整门禁误记为65证据。
