...
当前公开稳定版为 `0.6.3`、macOS build `18`，tag 为 [`v0.6.3`](https://github.com/sljzdotcom/AI-Token-Meter/releases/tag/v0.6.3)。macOS与Windows使用同一个`VERSION`、tag和GitHub Release；稳定appcast、Windows stable latest.json与旧Windows Preview feed均已指向0.6.3，公开证据记录在[0.6.3发布记录](2026-09-09-v0.6.3-release.md)。真机验收和代码签名证书状态继续独立记录。
