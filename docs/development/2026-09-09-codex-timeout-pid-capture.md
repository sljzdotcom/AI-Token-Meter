...
修复与本地证据提交为`60fe1eb`，验证记录为`7e44440`。[PR #21](https://github.com/sljzdotcom/AI-Token-Meter/pull/21)的macOS CI 34358581690与Windows CI 34358581569全绿，合并提交`dff54d8`的main macOS CI 34359878983与Windows CI 34359878996再次全绿。随后0.6.3发布workflow 34361767956重新运行同一完整Swift门禁并成功公开；原失败用例约1.042秒通过。公开Release、签名资产与更新源完成验证后，发布后证据提交`22443c3`的macOS CI 34365208106与Windows CI 34365208144再次全绿，本需求于2026-09-09结项。
