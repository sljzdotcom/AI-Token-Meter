...
| 日期 | 内容 | 结果 |
| --- | --- | --- |
| [2026-09-13](2026-09-13-bounded-command-timeout-test-reliability.md) | BoundedCommandRunner超时测试可靠性 | 从真实超时停止请求计量清理门限；失败先行、连续定向、完整Swift、独立复审与修正候选双平台CI通过，等待证据PR整合 |
| [2026-09-13](2026-09-13-v0.9.1-release.md) | 0.9.1两档悬浮条与摘要同步稳定发布 | v0.9.1/build27已公开；七项签名资产、篡改拒绝和三个更新源通过，等待证据PR最终CI与整合 |
