...
| [2026-08-31](2026-08-31-display-font-selection.md) | System Default、Antonio、DIN Condensed 全局显示字体、缺失回退与恢复默认 | 166 个测试、Release 构建/签名/安装指纹、Settings 切换和持久化通过；菜单与三个详情的字体视觉验收待手工完成，当前机器最终为 Antonio、右侧 97% |
