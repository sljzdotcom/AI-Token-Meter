...
| [2026-09-02](2026-09-02-public-github-release.md) | MIT 开源、作者信息、标准社区文档、脱敏截图、完整历史安全扫描与 v0.1.2 GitHub Release | 330 个测试、67 个测试组、本地三层发布审计及公开 CI 通过；标签、Release 与匿名下载复验仍在进行 |
