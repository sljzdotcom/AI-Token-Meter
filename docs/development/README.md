...
| 日期 | 内容 | 结果 |
| --- | --- | --- |
| [2026-09-04](2026-09-04-windows-console-window-suppression.md) | Windows 启动空白 Terminal 的 PE subsystem 根因、编译期修复与真实产物门禁 | subsystem `3` 红灯已复现，入口修复已提交；等待 Windows subsystem `2` 绿灯、双平台 `preview.2` 发布和 Windows 真机启动确认 |
