...
| 日期 | 内容 | 结果 |
| --- | --- | --- |
| [2026-09-09](2026-09-09-four-provider-onboarding-consistency.md) | 四服务商新用户接入与详情恢复一致性 | 双平台实现和定向回归通过；完整门禁、独立审查与发布进行中 |
| [2026-09-08](2026-09-08-v0.6.0-release.md) | 0.6.0 Gemini 与累积改进双平台稳定发布 | 发布准备中；本地候选门禁、原生 PR CI、双平台签名资产和公开更新源按顺序留证 |
| [2026-09-08](2026-09-08-gemini-collector.md) | Gemini CLI额度采集接入 | 本地实现、回归与独立审查收尾；原生Windows/真实账号受限，未合并发布 |
