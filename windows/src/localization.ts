...
const zh = {
  ...
  "Appearance": "外观", "Floating Strip": "悬浮条", "Monitoring": "监测", "Services": "服务", "About": "关于",
  "Content and Size": "内容与尺寸", "Screen and Position": "屏幕与位置", "Behavior": "行为",
  ...
  "Floating strip size": "浮动条大小", "Choose Comfortable or Compact.": "可选择舒适或紧凑模式。",
  "Compact": "紧凑", "Comfortable": "舒适", "Automatically collapse floating strip": "自动收起浮动条", "Turn off to keep the floating strip expanded.": "关闭后浮动条保持展开。", "Show delay (ms)": "显示延迟（毫秒）", "Hide delay (ms)": "收起延迟（毫秒）",
