...
export function MeterClipPaths({ density = "comfortable", count = 3, idPrefix = "strip-clip" }: { density?: string, count?: number, idPrefix?: string }) {
  ...
  const path = compact
    ? `M 56.5 12 C 50.5 17 48.75 21 35.75 22 C 13.75 23 0 42 0 70 L 0 ${216-removed} C 0 ${244-removed} 13.75 ${263-removed} 35.75 ${264-removed} C 48.75 ${265-removed} 50.5 ${269-removed} 56.5 ${274-removed} Z`
