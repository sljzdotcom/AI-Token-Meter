...
it.each([['compact','left',70,344],['compact','right',70,344],['comfortable','left',108,428],['comfortable','right',108,428]] as const)("four %s/%s buttons fit the same native size and remain selectable", (density,edge,width,height) => {
  let selected = ''
