...
const links = [
  ...
  { target: "telegram", label: "Telegram @sljzdotcom", href: "https://t.me/sljzdotcom" },
] as const
...
function BrandMark({target}: {target: BrandLinkTarget}) {
  ...
  if (target === "telegram") return <svg aria-hidden="true" className="author-link-icon" viewBox="0 0 24 24"><path d="M21.7 3.4 18.8 20c-.2 1.2-.9 1.5-1.8.9l-4.4-3.2-2.1 2c-.2.2-.4.4-.9.4l.3-4.5 8.2-7.4c.4-.3-.1-.5-.5-.2L7.5 14.4l-4.4-1.4c-1-.3-1-1 .2-1.4L20.4 3c.8-.3 1.5.2 1.3.4z" /></svg>
