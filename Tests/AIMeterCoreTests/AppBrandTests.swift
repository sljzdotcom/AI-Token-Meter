...
struct AppBrandTests {
    ...
    @Test("Provides the three approved browser destinations for About")
    func authorLinks() {
        #expect(AppBrand.authorLinks.map(\.label) == ["@MillerPanYue", "GitHub", "Telegram @sljzdotcom"])
